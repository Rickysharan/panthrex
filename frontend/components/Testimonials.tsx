...
const testimonials = [
  {
    ...
    quote:
      "Panthrex completely transformed my job search. The AI optimized my CV and I landed interviews within two weeks.",
  },
  {
    name: "David Chen",
  ...
  },
  {
    ...
    role: "Data Analyst",
    quote:
      "Instead of using five different websites, I managed everything from one dashboard. It's exactly what I needed.",
  },
];
